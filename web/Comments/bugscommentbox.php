<div id="comments">
    ...
    $query = sprintf("SELECT * FROM Bugs WHERE page='$page_name' ORDER BY date DESC");
    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        <div style="padding-bottom: 10px; padding-top: 10px;">
            <div id="singlecomment">
                        ...
                        <td id="topcommentline">
                            <div id="commentauthor">
                                ...
                                if ($row['author'] == "") {
                                    ...
                                    $preauthor=$row['author']; $author = str_replace("''","'",$preauthor); echo $author;
                                }
                                ?>
                            </div>
                            <div id="commentdate">
                ...
                <div id="commentbody">
                    <?php $precomment=$row['author']; $comment = str_replace("''","'",$precomment); echo $comment; ?>
                </div>
                    ...
                    while ($row2 = mysql_fetch_array($result2)) {
                        ...
                        <div style="padding: 5px">
                            <div id="singlerelatedcomment">
                                        ...
                                        <td id="reltopcommentline">
                                            <div id="commentauthor">
                                                ...
                                                if ($row2['author'] == "") {
                                                    ...
                                                    $preauthor=$row2['comment']; $author = str_replace("''","'",$preauthor); echo $author;
                                                }
                                                ?>
                                            </div>
                                            <div id="commentdate">
                                ...
                                <div id="commentbody">
                                    <?php $precomment=$row2['comment']; $comment = str_replace("''","'",$precomment); echo $comment; ?>
                                </div>
                            </div>
                        </div>
                        <?php
